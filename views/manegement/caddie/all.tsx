...
import Dangchoi from "../lto/dangchoi";
import Ketthuc from "../lto/ketthuc";
import Full from "./full";
import DangPhucVu from "./dangphucvu";
import DangRanh from "./dangranh";
import HetCa from "./hetca";
import TamNghi from "./tamnghi";
...
const All = () => {
  ...
  const [routes] = React.useState([
    ...
    { key: "second", title: "Đang phục vụ" },
    { key: "three", title: "Đang rảnh" },
    { key: "four", title: "Hết ca" },
    { key: "five", title: "Tạm nghỉ" },
  ]);
